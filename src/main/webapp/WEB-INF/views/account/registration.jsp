...
<html>
	...
	<h3 class="alert alert-success">Registration</h3>
		<from:form action="/account/registration" modelAttribute="user" enctype="multipart/form-data">
			...
			<div class="form-group"><label>Password</label><from:password path="password" cssClass="form-control"/>
			...
			<div class="form-group"><label>Full Name</label><from:input path="fullname" cssClass="form-control"/>
				<from:errors path="fullname"/>
			</div>
			<div class="form-group"><label>Email</label><from:input path="email" cssClass="form-control"/>
				<from:errors path="email"/>
			</div>
			<div class="form-group"><label>Phone Number</label><from:input path="phoneNumber" cssClass="form-control"/>
				<from:errors path="phoneNumber"/>
			</div>
			<div class="form-group"><label>Address</label><from:textarea cols="5" rows="3" path="address" cssClass="form-control"/>
